...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/report/generate"><i class="fa fa-line-chart"></i> Generate Report</a></li>
    <li class="active">Purchase Stock Report</li>
  </ol>
</section>
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-shopping-bag"></i> Purchase Stock Report
          ...
          <tbody>
            @foreach($transaction as $key => $value)
              <tr>
                ...
                <td> <i class="fa fa-inr"></i> {{ $value->purchase_total }}</td>
              </tr>
            @endforeach
          </tbody>
        </table>
